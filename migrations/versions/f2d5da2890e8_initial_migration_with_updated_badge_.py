"""Initial migration with updated Badge model

Revision ID: f2d5da2890e8
Revises: 
Create Date: 2024-05-19 03:33:00.158220
...
def upgrade():
    ...
    sa.Column('descr', sa.String(length=500), nullable=False),
